...
import com.github.wangfeng.procure.common.utils.security.Md5Utils;
import com.github.wangfeng.procure.common.utils.text.Convert;
import com.github.wangfeng.procure.dao.primary.system.SysPostMapper;
import com.github.wangfeng.procure.dao.primary.system.SysRoleMapper;
import com.github.wangfeng.procure.dao.primary.system.SysUserMapper;
import com.github.wangfeng.procure.dao.primary.system.SysUserPostMapper;
...
import com.github.wangfeng.procure.service.system.SysUserService;
...
public class SysUserServiceImpl implements SysUserService {
     ...
     */
    @Override
    public int updateUserInfo(SysUserDO user) {
        return userMapper.updateUser(user);
    }
     ...
     */
    @Override
    public int resetUserPwd(SysUserDO user) {
    ...
    public void insertUserPost(SysUserDO user) {
        ...
        if (StringUtils.isNotNull(posts)) {
            // 新增用户与岗位管理
            List<SysUserPostDO> list = new ArrayList<SysUserPostDO>();
     ...
     */
    @Override
    public String checkPhoneUnique(SysUserDO user) {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
        SysUserDO info = userMapper.checkPhoneUnique(user.getMobile());
     ...
     */
    @Override
    public String checkEmailUnique(SysUserDO user) {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
    ...
    public void checkUserAllowed(SysUserDO user) {
        ...
        if (StringUtils.isNotNull(user.getUserId()) && userDTO.isAdmin()) {
    ...
    public String selectUserRoleGroup(Long userId) {
        List<SysRoleDO> list = roleMapper.selectRolesByUserId(userId);
    ...
    public String selectUserPostGroup(Long userId) {
        List<SysPostDO> list = postMapper.selectPostsByUserId(userId);
        StringBuffer idsStr = new StringBuffer();
    ...
    public String importUser(List<SysUserDO> userList, Boolean isUpdateSupport, String operName) {
        ...
        for (SysUserDO user : userList) {
            try {
                // 验证是否存在这个用户
                SysUserDO u = userMapper.selectUserByLoginName(user.getLoginName());
