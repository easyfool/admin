...
public class SysMenuController extends BaseController
{
    ...
    public List<SysMenuDO> list(SysMenuDO menu)
    {
        ...
        List<SysMenuDO> menuList = menuService.selectMenuList(menu, userId);
        return menuList;
    }
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysMenuDO menu)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysMenuDO menu)
    {
        if (UserConstants.MENU_NAME_NOT_UNIQUE.equals(menuService.checkMenuNameUnique(menu)))
        {
    ...
    @ResponseBody
    public List<Ztree> roleMenuTreeData(SysRoleDO role)
    {
        Long userId = ShiroUtils.getUserId();
