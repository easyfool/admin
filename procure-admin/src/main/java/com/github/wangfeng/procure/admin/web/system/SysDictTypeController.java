...
public class SysDictTypeController extends BaseController {
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(SysDictTypeDO dictType) {
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysDictTypeDO dict) {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysDictTypeDO dict) {
        if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict))) {
    ...
    public List<Ztree> treeData() {
        List<Ztree> ztrees = dictTypeService.selectDictTree(new SysDictTypeDO());
        return ztrees;
    }
}
