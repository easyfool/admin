...
public class SysConfigController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(SysConfigDO config)
    {
        List<SysConfigDO> list = configService.selectConfigList(config);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysConfigDO config)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysConfigDO config)
    {
        if (UserConstants.CONFIG_KEY_NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config)))
        {
    ...
    @ResponseBody
    public String checkConfigKeyUnique(SysConfigDO config)
    {
