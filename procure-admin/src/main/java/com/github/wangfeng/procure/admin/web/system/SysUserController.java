...
import com.github.wangfeng.procure.core.shiro.service.SysPasswordService;
import com.github.wangfeng.procure.core.utils.ShiroUtils;
import com.github.wangfeng.procure.service.system.SysPostService;
...
public class SysUserController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(SysUserDO user)
    {
        List<SysUserDO> list = userService.selectUserList(user);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysUserDO user)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysUserDO user)
    {
    ...
    @ResponseBody
    public AjaxResult resetPwdSave(SysUserDO user)
    {
        userService.checkUserAllowed(user);
        user.setSalt(ShiroUtils.randomSalt());
        user.setPassword(passwordService.encryptPassword(user.getLoginName(), user.getPassword(), user.getSalt()));
    ...
    @ResponseBody
    public String checkLoginNameUnique(SysUserDO user)
    {
    ...
    @ResponseBody
    public AjaxResult changeStatus(SysUserDO user)
    {
        userService.checkUserAllowed(user);
