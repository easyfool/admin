...
public class SysRoleController extends BaseController
{
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(SysRoleDO role)
    {
        List<SysRoleDO> list = roleService.selectRoleList(role);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated SysRoleDO role)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated SysRoleDO role)
    {
    ...
    @ResponseBody
    public AjaxResult authDataScopeSave(SysRoleDO role)
    {
        roleService.checkRoleAllowed(role);
        role.setUpdateBy(ShiroUtils.getLoginName());
    ...
    @ResponseBody
    public AjaxResult changeStatus(SysRoleDO role)
    {
        roleService.checkRoleAllowed(role);
    ...
    @ResponseBody
    public AjaxResult cancelAuthUser(SysUserRoleDO userRole)
    {
