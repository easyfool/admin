package com.github.wangfeng.procure.core.shiro.web.session;
...
import com.github.wangfeng.procure.common.utils.bean.BeanUtils;
...
public class OnlineWebSessionManager extends DefaultWebSessionManager
{
    ...
    public void validateSessions()
    {
        ...
        List<SysUserOnlineDO> userOnlineList = userOnlineService.selectOnlineByExpired(expiredDate);
        // 批量过期删除
        List<String> needOfflineIdList = new ArrayList<String>();
        for (SysUserOnlineDO userOnline : userOnlineList)
        {
            try
            {
