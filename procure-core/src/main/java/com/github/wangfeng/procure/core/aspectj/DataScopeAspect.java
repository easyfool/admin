...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.github.wangfeng.procure.common.annotation.DataScope)")
     ...
     * @param alias 别名
     */
    public static void dataScopeFilter(JoinPoint joinPoint, SysUserDO user, String deptAlias, String userAlias)
    {
