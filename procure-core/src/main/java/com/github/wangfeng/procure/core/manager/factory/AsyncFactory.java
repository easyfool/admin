package com.github.wangfeng.procure.core.manager.factory;
...
import com.github.wangfeng.procure.common.utils.AddressUtils;
...
import com.github.wangfeng.procure.core.utils.LogUtils;
...
public class AsyncFactory {
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session) {
        return new TimerTask() {
            @Override
            public void run() {
                SysUserOnlineDO online = new SysUserOnlineDO();
