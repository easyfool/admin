...
import com.github.wangfeng.procure.common.constant.ShiroConstants;
import com.github.wangfeng.procure.common.constant.UserConstants;
import com.github.wangfeng.procure.common.exception.user.CaptchaException;
import com.github.wangfeng.procure.common.exception.user.UserNotExistsException;
import com.github.wangfeng.procure.common.exception.user.UserPasswordNotMatchException;
...
import com.github.wangfeng.procure.common.utils.MessageUtils;
import com.github.wangfeng.procure.common.utils.ServletUtils;
import com.github.wangfeng.procure.core.manager.AsyncManager;
import com.github.wangfeng.procure.core.manager.factory.AsyncFactory;
...
public class SysLoginService {
    ...
    public SysUserDO login(String username, String password) {
        ...
        // 查询用户信息
        SysUserDO user = userService.selectUserByLoginName(username);
